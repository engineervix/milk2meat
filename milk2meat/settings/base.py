"""
Django settings for milk2meat project.
...
APPS_DIR = ROOT_DIR.path("milk2meat")
...
ROOT_URLCONF = "milk2meat.urls"

# WSGI
# ------------------------------------------------------------------------------
# https://docs.djangoproject.com/en/5.1/ref/settings/#wsgi-application
WSGI_APPLICATION = "milk2meat.wsgi.application"
...
# https://docs.djangoproject.com/en/5.1/ref/contrib/gis/db-api/#module-django.contrib.gis.db.backends
...
# # https://docs.djangoproject.com/en/5.1/ref/settings/#std-setting-FILE_UPLOAD_MAX_MEMORY_SIZE
...
# CUSTOM SETTINGS
# ------------------------------------------------------------------------------
ADMIN_URL = "djadmin/"  # Django Admin URL.
